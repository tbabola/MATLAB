...
%           '150710\15710010.abf',0,600,600,601
            ...
            %WT + MRS25000
            '150719\15719003.abf',0,600,780,1380
            '150723\15723000.abf',0,600,780,1380
            '150723\15723002.abf',0,600,780,1380
            '150723\15723003.abf',0,600,780,1380
            '150723\15723006.abf',60,660,840,1440
            '150724\15724007.abf',0,600,780,1380
            '150725\15725007.abf',0,600,780,1380
...
for i=1:size(files,1)
   ...
   ISI_data{i,8}=max(b_ISI_burstdata(:,3));
   ...
   ISI_data{i,9}=max(d_ISI_burstdata(:,3));
   clearvars ISI_burstdata intervals burst_locs;
   ...
   b_ISI_tot = vertcat(b_ISI_tot, b_ISIs);
   d_ISI_tot = vertcat(d_ISI_tot,d_ISIs);
...
[f_wt,t]=ksdensity(log10(b_ISI_tot),[0:0.01:5]');
[f_MRS,t]=ksdensity(log10(d_ISI_tot),[0:0.01:5]');
[f_KO,t]=ksdensity(log10(KO),[0:0.01:5]');
