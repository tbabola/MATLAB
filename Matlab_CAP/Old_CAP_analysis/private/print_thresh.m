...
xlabel(get(FIG.ax1.xlab,'string'),'FontSize',14);
ylabel(get(FIG.ax1.ylab,'string'),'FontSize',14,'Interpreter','tex');
title(get(FIG.ax1.title,'string'),'FontSize',14);
drawnow;
