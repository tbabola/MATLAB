...
db(i).date          = '2017';
db(i).expts         = [3]; % leave empty, or specify subolders as numbers
db(i).diameter      = 16;
db(i).RootDir       = 'M:\Bergles Lab Data\Projects\In Vivo Imaging and VG3 Paper\In Vitro Experiments\VG3KO + NBQX + BBE\170914_Image5_VG3KO_NBQX_BBE\Image5'; % specify full path to tiffs here
