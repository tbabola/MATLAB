...
addpath('C:\Users\Bergles Lab\Documents\MATLAB\MATLAB\Utilities') % add the path to your make_db file

% overwrite any of these default options in your make_db file for individual experiments
S2P_make_db; % RUN YOUR OWN MAKE_DB SCRIPT TO RUN HERE

ops0.toolbox_path = 'C:\Users\Bergles Lab\Documents\Github\Suite2P';
...
ops0.temp_tiff              = 'C:/Users/Bergles Lab/Desktop/temp/temp.tif'; % copies each remote tiff locally first, into this file
ops0.RegFileRoot            = 'C:/Users/Bergles Lab/Desktop/temp/DATA/';  % location for binary file
ops0.DeleteBin              = 1; % set to 1 for batch processing on a limited hard drive
ops0.ResultsSavePath        = 'C:/Users/Bergles Lab/Desktop/temp/DATA/DATA/F'; % a folder structure is created inside
